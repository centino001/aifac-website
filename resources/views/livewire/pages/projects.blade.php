<div>
        ...
        <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 lg:h-full lg:flex lg:items-center lg:justify-center">
            <div class="text-center">
                ...
                <p class="text-lg sm:text-xl md:text-2xl mb-6 sm:mb-8 max-w-3xl mx-auto drop-shadow-md px-4">
                    Discover the impactful initiatives and creative endeavors that embody our mission to preserve,
                    develop, and unify African art and culture.
                </p>
                <div class="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center px-4">
                    {{-- <a href="#featured-projects"
                        class="bg-orange-600 text-white px-6 sm:px-8 py-3 rounded-lg font-semibold hover:bg-orange-700 transition duration-300 text-center">
                        View Featured Projects
                    </a> --}}
                    {{-- <a href="#all-projects"
                        class="border-2 border-white text-white px-6 sm:px-8 py-3 rounded-lg font-semibold hover:bg-white hover:text-blue-800 transition duration-300 text-center">
                        Browse All Projects
                    </a> --}}
                </div>
            </div>
    ...
    {{-- <section class="py-12 sm:py-16 bg-black">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-8 sm:mb-12">
                <h2 class="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-3 sm:mb-4 px-4">Project Categories
                </h2>
                ...
                <div class="bg-black rounded-lg p-6 hover:bg-gray-700 transition duration-300 border border-gray-700 cursor-pointer"
                    ...
                    <div class="bg-rose-600 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                        <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M9 9h.01M9 12h.01M9 15h.01M9 18h.01"></path>
                    ...
                    <div class="bg-emerald-600 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                        <svg class="w-8 h-8 text-white" fill="currentColor" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="0.5"
                                d="M8 9c0-2.21 1.79-4 4-4s4 1.79 4 4-1.79 4-4 4-4-1.79-4-4z"></path>
    ...
    <section id="featured-projects" class="py-12 sm:py-16 bg-black">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-8 sm:mb-12">
                <h2 class="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-3 sm:mb-4 px-4">Featured Projects
                </h2>
                <p class="text-base sm:text-lg text-gray-300 max-w-3xl mx-auto px-4">
                    Highlighting our most impactful and innovative initiatives that showcase the depth and breadth of
                    our work.
                </p>
            </div>
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
                <!-- Featured Project 1 -->
                <div
                    class="bg-black rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition duration-300 border border-gray-700">
                    <div class="h-48 bg-cover bg-center bg-no-repeat relative" style="background-image: url('https://res.cloudinary.com/dgsctl247/image/upload/v1759218155/ekonke_b8v34s.jpg')">
                        <div class="absolute inset-0 bg-black bg-opacity-20"></div>
                        <div class="absolute bottom-4 left-4">
                            <span class="bg-amber-600 text-white px-3 py-1 rounded-full text-sm font-medium">Cultural
                                Preservation</span>
                        </div>
                    </div>
                    <div class="p-6">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <a href="/projects/ekonke" class="text-amber-400 hover:text-amber-300 font-medium">Learn More →</a>
                        </div>
                    </div>
                </div>
                ...
                {{-- <div
                    ...
                    <div class="h-48 bg-gradient-to-br from-rose-500 to-rose-700 relative">
                        <div class="absolute inset-0 bg-black bg-opacity-20"></div>
                        <div class="absolute bottom-4 left-4">
                            <span class="bg-rose-600 text-white px-3 py-1 rounded-full text-sm font-medium">Artistic
                                Development</span>
                        </div>
                    </div>
                    <div class="p-6">
                        ...
                        <p class="text-gray-300 mb-4">
                            Empowering emerging artists through structured mentorship, skill development workshops, and
                ...
                {{-- <div
                    ...
                    <div class="h-48 bg-gradient-to-br from-emerald-500 to-emerald-700 relative">
                        <div class="absolute inset-0 bg-black bg-opacity-20"></div>
                        <div class="absolute bottom-4 left-4">
                            <span class="bg-emerald-600 text-white px-3 py-1 rounded-full text-sm font-medium">Unity &
                                Ecosystem</span>
                        </div>
                    </div>
                    <div class="p-6">
                        ...
                        <p class="text-gray-300 mb-4">
                            Building bridges between African cultural institutions to facilitate knowledge sharing and
                            collaborative projects.
                        </p>
                        <div class="flex items-center justify-between">
                            <span class="text-sm text-gray-400">Status: Planning</span>
                            <a href="#" class="text-emerald-400 hover:text-emerald-300 font-medium">Learn More
                                →</a>
                        </div>
                    </div>
                </div> --}}
    ...
    {{-- <section id="all-projects" class="py-12 sm:py-16 bg-black">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-8 sm:mb-12">
                ...
                <div class="flex flex-wrap justify-center gap-2 sm:gap-3 md:gap-4 mb-6 sm:mb-8 px-4">
                    <button onclick="filterProjects('all')"
                        class="filter-btn active bg-blue-600 text-white px-3 sm:px-4 py-2 rounded-lg text-sm sm:text-base font-medium hover:bg-blue-700 transition duration-300">
                        All Projects
                    </button>
                    <button onclick="filterProjects('cultural')"
                        class="filter-btn bg-orange-600 text-white px-3 sm:px-4 py-2 rounded-lg text-sm sm:text-base font-medium hover:bg-orange-400 hover:text-black transition duration-300">
                        <span class="hidden sm:inline">Cultural Preservation</span>
                        <span class="sm:hidden">Cultural</span>
                    </button>
                    <button onclick="filterProjects('artistic')"
                        class="filter-btn bg-rose-700 text-white px-3 sm:px-4 py-2 rounded-lg text-sm sm:text-base font-medium hover:bg-rose-400 hover:text-black transition duration-300">
                        <span class="hidden sm:inline">Artistic Development</span>
                        <span class="sm:hidden">Artistic</span>
                    </button>
                    <button onclick="filterProjects('unity')"
                        class="filter-btn bg-emerald-700 text-white px-3 sm:px-4 py-2 rounded-lg text-sm sm:text-base font-medium hover:bg-emerald-400 hover:text-black transition duration-300">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8" id="projects-grid">
                <!-- Project 1 - Cultural -->
                <div class="project-card bg-gray-800 rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition duration-300"
                    data-category="cultural">
                    <div class="h-40 bg-gradient-to-br from-amber-400 to-amber-600"></div>
                    <div class="p-6">
                        <div class="flex items-center justify-between mb-2">
                            <span
                                class="bg-amber-100 text-amber-800 px-2 py-1 rounded-full text-xs font-medium">Cultural</span>
                        ...
                        <a href="#" class="text-amber-400 hover:text-amber-300 text-sm font-medium">View Project
                            →</a>
                    </div>
                </div>
                ...
                <div class="project-card bg-gray-800 rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition duration-300"
                    ...
                    <div class="p-6">
                        <div class="flex items-center justify-between mb-2">
                            <span
                                class="bg-rose-100 text-rose-800 px-2 py-1 rounded-full text-xs font-medium">Artistic</span>
                            <span class="text-xs text-gray-400">2024</span>
                        </div>
                        ...
                        <a href="#" class="text-rose-400 hover:text-rose-300 text-sm font-medium">View Project
                            →</a>
                    </div>
                </div>
                ...
                <div class="project-card bg-gray-800 rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition duration-300"
                    ...
                    <div class="p-6">
                        <div class="flex items-center justify-between mb-2">
                            <span
                                class="bg-emerald-100 text-emerald-800 px-2 py-1 rounded-full text-xs font-medium">Unity</span>
                            <span class="text-xs text-gray-400">2024</span>
                        </div>
                        ...
                        <a href="#" class="text-emerald-400 hover:text-emerald-300 text-sm font-medium">View
                            Project →</a>
                    </div>
                </div>
    ...
    {{-- <section class="py-12 sm:py-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p class="text-base sm:text-lg md:text-xl text-blue-100 mb-6 sm:mb-8 max-w-3xl mx-auto px-4">
                We're always looking for passionate individuals and organizations to partner with us in preserving and
                promoting African art and culture.
            </p>
            <div class="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center px-4">
                <a href="#"
                    class="bg-white text-blue-600 px-6 sm:px-8 py-3 rounded-lg font-semibold hover:bg-gray-100 transition duration-300 text-center">
                    Propose a Project
                </a>
                <a href="#"
                    class="border-2 border-white text-white px-6 sm:px-8 py-3 rounded-lg font-semibold hover:bg-white hover:text-blue-600 transition duration-300 text-center">
                    Contact Us
                </a>
            </div>
        </div>
